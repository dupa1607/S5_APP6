...
hold on
yline(gamma_ref_300, 'r')
plot(tv, gamma_ref_300_rt,'black')
grid minor
title('angle de vol avec asservissment (300)', "FontSize",20)
...
grid minor
title('vitesse en fonction du temps avec asservissement (300)', "FontSize",20)
xlabel("temps (s)", "FontSize",15)
...
grid minor
title('vitesse en fonction de la hauteur avec asservissement (300)', "FontSize",20)
xlabel("hauteur(km)", "FontSize",15)
ylabel("vitesse (m/s)", "FontSize",15)
xline(z(index,3)/1000, '--')
...
grid minor
title('hauteur avec asservissment (300)', "FontSize",20)
xlabel("temps (s)", "FontSize",15)
...
grid minor
title('Pression dynamique et trainée aerodynamique avec asservissement (300)', "FontSize",20)
xlabel("temps(s)", "FontSize",15)
...
grid minor
title('Intégrale de Daero avec asservissement (300)', "FontSize",20)
xlabel("temps (s)", "FontSize",15)
